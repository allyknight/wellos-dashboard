...
const DASHBOARD_DATA = {
  ...
  epics: [
    ...
    { id: "E-01", name: "Behavioral Signals Pipeline",       initiative: "INIT-01", owner: "Ally Knight",   status: "completed",   progress: 100, targetDate: "2026-02-28" },
    { id: "E-02", name: "Recommendation Algorithm v1",       initiative: "INIT-01", owner: "Ally Knight",    status: "on-track",    progress: 70,  targetDate: "2026-04-30" },
    { id: "E-03", name: "Personalized Content Feed",         initiative: "INIT-01", owner: "Ally Knight",      status: "on-track",    progress: 55,  targetDate: "2026-05-31" },
    { id: "E-04", name: "Coaching Nudge Engine",             initiative: "INIT-01", owner: "Ally Knight",    status: "at-risk",     progress: 30,  targetDate: "2026-06-15" },

    // INIT-02: Provider Integration
    { id: "E-05", name: "EHR Data Ingestion Layer",          initiative: "INIT-02", owner: "Ally Knight",  status: "at-risk",     progress: 40,  targetDate: "2026-04-15" },
    { id: "E-06", name: "Provider Portal Prototype",         initiative: "INIT-02", owner: "Ally Knight",   status: "not-started", progress: 0,   targetDate: "2026-06-30" },
    { id: "E-07", name: "Care Summary Export (HL7 FHIR)",    initiative: "INIT-02", owner: "Ally Knight",  status: "blocked",     progress: 15,  targetDate: "2026-05-01" },

    // INIT-03: GLP-1 Support
    { id: "E-08", name: "Medication Tracking Module",        initiative: "INIT-03", owner: "Ally Knight", status: "completed",   progress: 100, targetDate: "2026-03-07" },
    { id: "E-09", name: "Side-Effect Symptom Logger",        initiative: "INIT-03", owner: "Ally Knight",  status: "on-track",    progress: 75,  targetDate: "2026-04-01" },
    { id: "E-10", name: "GLP-1 Nutrition Content Library",   initiative: "INIT-03", owner: "Ally Knight", status: "on-track",    progress: 60,  targetDate: "2026-04-30" },
    { id: "E-11", name: "Progress Milestone Celebrations",   initiative: "INIT-03", owner: "Ally Knight",      status: "at-risk",     progress: 20,  targetDate: "2026-05-15" },

    // INIT-04: Data Foundation
    { id: "E-12", name: "Event Streaming Infrastructure",    initiative: "INIT-04", owner: "Ally Knight",   status: "completed",   progress: 100, targetDate: "2026-01-31" },
    { id: "E-13", name: "Member Data Warehouse (Phase 1)",   initiative: "INIT-04", owner: "Ally Knight",   status: "on-track",    progress: 85,  targetDate: "2026-03-31" },
    { id: "E-14", name: "Self-Service Analytics Dashboard",  initiative: "INIT-04", owner: "Ally Knight",    status: "on-track",    progress: 65,  targetDate: "2026-04-30" },

    // INIT-05: Mobile Revamp
    { id: "E-15", name: "Design System Update",              initiative: "INIT-05", owner: "Ally Knight",   status: "on-track",    progress: 50,  targetDate: "2026-04-30" },
    { id: "E-16", name: "Home Dashboard Redesign",           initiative: "INIT-05", owner: "Ally Knight",   status: "at-risk",     progress: 30,  targetDate: "2026-06-15" },
    { id: "E-17", name: "Onboarding Flow Revamp",            initiative: "INIT-05", owner: "Ally Knight",    status: "blocked",     progress: 10,  targetDate: "2026-07-31" },
    { id: "E-18", name: "Accessibility Compliance (WCAG 2.2)",initiative:"INIT-05", owner: "Ally Knight",   status: "not-started", progress: 0,   targetDate: "2026-08-31" },
  ],

  /* ── MILESTONES ───────────────────────────────────────── */
  milestones: [
    { name: "Data Warehouse Phase 1 Complete", date: "2026-03-31", owner: "Ally Knight",   type: "upcoming" },
    { name: "GLP-1 Side-Effect Logger Launch",  date: "2026-04-01", owner: "Ally Knight",  type: "upcoming" },
    { name: "Recommendation Algorithm Beta",    date: "2026-04-30", owner: "Ally Knight",    type: "future"   },
    { name: "EHR Ingestion Layer — Go/No-Go",   date: "2026-04-15", owner: "Ally Knight",  type: "upcoming" },
    { name: "Mobile Design System Handoff",     date: "2026-04-30", owner: "Ally Knight",   type: "future"   },
    { name: "GLP-1 Content Library Launch",     date: "2026-04-30", owner: "Ally Knight", type: "future"   },
    { name: "Self-Service Analytics v1",        date: "2026-04-30", owner: "Ally Knight",    type: "future"   },
    { name: "Personalized Content Feed Beta",   date: "2026-05-31", owner: "Ally Knight",      type: "future"   },
  ],
